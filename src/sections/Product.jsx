  ...
  return (
    <div>
      ...
      <div className="lg:px-10 px-2">
        ...
        <div className="py-5">
          {products ?  <div className="grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-4  grid-cols-2 sm:grid-cols-2 h-full">
            {Array.isArray(products) && products.slice(0, itemsToShow).map((item, idx) => (
              <Product_Card product={item} key={idx} />
            ))}
          </div> : <p className="text-center flex"><span className="animate-spin text-blue-700"><Loader/></span> Loading Please wait </p>}
